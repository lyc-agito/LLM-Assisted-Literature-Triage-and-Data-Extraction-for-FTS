...
if __name__ == '__main__':
    ...
    stds = read_excel_columns_to_json("originality_sample.xlsx", "held-out subset", ["Index", "Human"])
    results = read_excel_columns_to_json("originality_sample.xlsx", "held-out subset", ["Index", "Doubao", "DeepSeek", "Kimi"])
