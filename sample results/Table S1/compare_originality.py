...
if __name__ == '__main__':
    ...
    file_name = "originality_sample.xlsx"
    ...
    print(f"total: {total}")
    print(f"doubao: {f1_cf(doubao) * 100:.2f} / {acc_cf(doubao) * 100:.2f}")
    print(f"deepseek: {f1_cf(deepseek) * 100:.2f} / {acc_cf(deepseek) * 100:.2f}")
    print(f"kimi: {f1_cf(kimi) * 100:.2f} / {acc_cf(kimi) * 100:.2f}")
